      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <p className="text-xs leading-relaxed mb-4 max-w-xs" style={{ color: 'var(--muted)' }}>
              ICT Officer & Software Developer based in Nairobi, Kenya. Building practical systems
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-xs" style={{ color: 'var(--muted)' }}>
                ...
                <a href={`https://wa.me/${siteData.whatsapp.replace(/\D/g,'')}`} target="_blank" rel="noopener noreferrer"
