        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="rounded-xl p-6 space-y-4"
            ...
            <div>
              ...
              <textarea name="message" className="form-input" rows={5} placeholder="Tell me about your project..."
            ...
            <button type="submit" disabled={status === 'sending'}
              ...
              {status === 'error' && '✗ Failed — email me directly instead'}
            </button>
            {status === 'error' && (
              <p className="text-xs text-center" style={{ color: 'var(--muted)' }}>
                Something went wrong. Please use{' '}
                <a href={`mailto:${siteData.email}`} className="underline" style={{ color: 'var(--cyan)' }}>
                  {siteData.email}
                </a>{' '}directly for now.
              </p>
            )}
